...
<body>
	...
	<div class="jumbotron">
	<div class="container">
	<h2 class="text-center">Editar Suas Informações</h2>
		<form class="form-group" action="usuario" method="post">
			<input class="form-control" type="text" name="nome" placeholder="Nome" value="${user.getNome()}"><br>
			<input class="form-control" type="hidden" name="email" placeholder="Email" value="${user.getEmail()}">
			<input class="form-control" type="email" name="email" placeholder="Email" value="${user.getEmail()}" disabled title="Este Campo não pode ser alterado"><br>
			<input class="form-control" type="text" name="cpf" placeholder="Cpf" value="${user.getCpf()}"><br>
			<input class="form-control" type="password" name="senha" placeholder="Senha" value="${user.getSenha()}"><br>
			<button class="btn btn-success btn-block" type = "submit">Salvar Edição</button>
		</form>
	</div>
</div>
</body>
